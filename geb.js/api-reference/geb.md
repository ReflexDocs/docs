...
The main package used to interact with the GEB system. Includes [helper functions](broken-reference) for safe management and the [contract interface object](broken-reference) to directly call smart contracts.

## Constructors

\+ **new Geb**(`network`: GebDeployment, `provider`: GebProviderInterface | Provider): [_Geb_](broken-reference)
...
**Returns:** [_Geb_](broken-reference)
...
▸ **getProxyAction**(`ownerAddress`: string): _Promise‹_[_GebProxyActions_](broken-reference)_‹››_
...
**Returns:** _Promise‹_[_GebProxyActions_](broken-reference)_‹››_

### getSafe

▸ **getSafe**(`idOrHandler`: string | number, `collateralType?`: string): _Promise‹_[_Safe_](broken-reference)_›_
...
**Returns:** _Promise‹_[_Safe_](broken-reference)_›_

### getSafeFromOwner

▸ **getSafeFromOwner**(`address`: string): _Promise‹_[_Safe_](broken-reference)_\[]›_
